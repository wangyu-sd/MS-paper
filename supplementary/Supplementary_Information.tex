...
\large A structural census of the dark metabolome}
\author{}
\date{}
...
This document contains the supporting experiments for five linked claims: credible bounded structural measurement, a feature-to-entity census, global chemical organization, biological-source partition and the biological value of structural-family analysis. The notes follow evidentiary dependency rather than main-figure order. Decision experiments on prospective validation, the soundness--resolution operating point and entity collapsing are load-bearing: a failure changes the main-text claim rather than merely moving a panel to supplementary material.
...
\section{Structural census and chemical organization of the dark metabolome}
